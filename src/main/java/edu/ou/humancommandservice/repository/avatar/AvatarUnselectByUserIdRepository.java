...
public class AvatarUnselectByUserIdRepository extends BaseRepository<Integer, Integer> {
    ...
    /**
     * Delete exist userId by userId id
     *
    ...
    protected Integer doExecute(Integer userId) {
        final String hqlQuery =
                "UPDATE AvatarEntity A " +
                        ...
                        "WHERE A.userId = :userId AND A.isDeleted IS NULL ";
