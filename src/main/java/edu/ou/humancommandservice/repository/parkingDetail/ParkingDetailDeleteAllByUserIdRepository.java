...
public class ParkingDetailDeleteAllByUserIdRepository extends BaseRepository<Integer, Integer> {
    ...
    /**
     * Delete exist parking detail by user id
     *
     * @param userId user id
     * @return row change
     * @author Nguyen Trung Kien - OU
    ...
    protected Integer doExecute(Integer userId) {
        final String hqlQuery = "DELETE FROM ParkingDetailEntity P WHERE P.userId = :userId";
