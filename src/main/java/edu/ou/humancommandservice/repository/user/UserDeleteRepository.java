...
public class UserDeleteRepository extends BaseRepository<Integer, Integer> {
     ...
     * Delete exist user
     *
     * @param userId slug of exist user
     * @return slug of exist user
     * @author Nguyen Trung Kien - OU
     */
    @Override
    protected Integer doExecute(Integer userId) {
        final String hqlQuery =
                "UPDATE UserEntity U " +
                        "SET U.isDeleted = CURRENT_TIMESTAMP " +
                        "WHERE U.id = :userId";
