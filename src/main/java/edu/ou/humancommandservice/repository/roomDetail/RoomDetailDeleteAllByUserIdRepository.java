...
public class RoomDetailDeleteAllByUserIdRepository extends BaseRepository<Integer, Integer> {
    ...
    /**
     * Delete exist room detail by user id
     *
     * @param userId user id
     * @return row change
     * @author Nguyen Trung Kien - OU
    ...
    protected Integer doExecute(Integer userId) {
        final String hqlQuery = "DELETE FROM RoomDetailEntity R WHERE R.userId = :userId";
